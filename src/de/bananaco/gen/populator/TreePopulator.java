...
public class TreePopulator extends BlockPopulator {
	...
	public enum Type { 
		FOREST, PLAINS, RAINFOREST, SAVANNA, SEASONAL_FOREST, SHRUBLAND, SWAMPLAND, TAIGA, TUNDRA 
	}

	@Override
	public void populate(final World world, final Random rand, final Chunk chunk) {
		this.doPopulate(world, rand, chunk);
		//Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Bukkit.getPluginManager().getPlugin("3DGen"), new TreeRunnable(world, rand, chunk, this), 1);
	}

	public void doPopulate(World world, Random random, Chunk chunk) {
